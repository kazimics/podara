...
object Settings {
    private val settingsFile = File(System.getProperty("user.home"), ".podara/settings.properties")
    ...
    private fun defaultDownloadPath(): String {
        return File(System.getProperty("user.home"), ".podara/downloads").absolutePath
    }
}
