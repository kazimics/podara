...
class FakeFetchPodcastClient(
    private val podcastTitle: String = "Fake Podcast",
    private val episode1Title: String = "Episode 1",
    private val episode1AudioUrl: String = "https://example.com/audio1.mp3"
) : FetchPodcastClient() {
        ...
        get() = """
            ...
            <rss version="2.0" xmlns:itunes="http://www.itunes.com/dtds/podcast-1.0.dtd">
              <channel>
                ...
                <item>
                  <title>$episode1Title</title>
                  <link>https://example.com/ep1</link>
                  <description>First episode</description>
                  <guid>ep-1</guid>
                  <pubDate>Mon, 01 Jan 2024 00:00:00 +0000</pubDate>
                  <enclosure url="$episode1AudioUrl" type="audio/mpeg"/>
                </item>
                <item>
